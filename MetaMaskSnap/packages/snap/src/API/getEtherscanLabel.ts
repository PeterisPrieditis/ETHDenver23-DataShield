/*
let element = ''; 
await fetch(`https://polygonscan.com/address/0xe7d162ff34bcf5e5efc301fa061cbfb51341a814`)
...
export async function getEtherscanLabel(chainIdDec: number, address: string) {
  ...
  switch (chainIdDec) {
    case 1:
      // Ethereum Mainnet
      api_url = 'https://etherscan.io/address/${address}';
      break;
    case 137:
      // Polygon Mainnet
      api_url = `https://polygonscan.com/address/${address}`;
      break;
    default:
